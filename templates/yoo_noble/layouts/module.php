...
// legacy compatibility
	...
	if ($style == '') {
		...
		if ($module->position == 'top') $style = 'border';
		if ($module->position == 'left') $style = 'banner';
		if ($module->position == 'right') $style = 'banner';
		if ($module->position == 'contentleft') $style = 'line';
		if ($module->position == 'contentright') $style = 'line';
		if ($module->position == 'bottom') $style = 'border';
	...
	if ($module->position == 'menu') $style = ($style == 'menu') ? 'raw' : 'dropdown';
