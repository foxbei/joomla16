...
// force module style
if (($module->position == 'toolbarleft' || $module->position == 'toolbarright') && $style=='menu') $style = 'toolbar';
...
switch ($style) {
	...
	case 'rounded':
		$template  = '3-3-3';
		$style     = 'mod-'.$style;
		if (in_array($module->position,array('headerleft','headerright','left','right','bottom','bottomblock','top','topblock'))) {
