...
<div class="item">
	...
	<div class="date">
		<div class="month"><?php echo JHTML::_('date', $this->item->created, JText::_('%b')); ?></div><div class="day"><?php echo JHTML::_('date', $this->item->created, JText::_('%d')); ?></div>
	</div>
	<?php endif; ?>
	...
	<p class="meta">
		...
		<?php
			...
			if (($this->item->params->get('show_author')) && ($this->item->author != "")) {
				echo '<span><span>'.JText::_('Author').'</span> // '.($this->item->created_by_alias ? $this->item->created_by_alias : $this->item->author).'</span>';
			}
