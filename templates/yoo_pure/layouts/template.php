...
<body id="page" class="yoopage <?php echo $this->warp->config->get('columns'); ?> <?php echo $this->warp->config->get('itemcolor'); ?> <?php echo $this->warp->config->get('toolscolor'); ?> <?php echo 'style-'.$this->warp->config->get('style'); ?> <?php echo 'color-'.$this->warp->config->get('color'); ?> <?php echo 'texture-'.$this->warp->config->get('texture'); ?> <?php echo 'font-'.$this->warp->config->get('font'); ?> <?php echo $this->warp->config->get('webfonts'); ?>">
					...
					<div id="middle-expand">
						...
						<div id="main">
							<div id="main-shift">
								...
								<div id="mainbottom">
									<div class="mainbottom-separator"></div>
